      ...
      <section className={styles.hero}>
        ...
        <div className={styles.content}>
          <h1 className={styles.heading}>
            Experience Premium Catering in Nagpur
          </h1>
          <p className={styles.subheading}>
            From elegant wedding receptions to corporate gatherings and intimate private parties,
            <br />
            we deliver exceptional culinary experiences that delight your guests.
          </p>
      ...
      <section className={styles.stats}>
        <div className={styles.statsGrid}>
          <div className={styles.statItem}>
            <h2 className={styles.statValue}>500+</h2>
            <p className={styles.statLabel}>Events Catered</p>
          </div>
          <div className={styles.statItem}>
            <h2 className={styles.statValue}>4.9★</h2>
            <p className={styles.statLabel}>Customer Rating</p>
          </div>
          <div className={styles.statItem}>
            <h2 className={styles.statValue}>15+</h2>
      ...
      <section className={styles.services}>
        <div className={styles.servicesContainer}>
          <div className={styles.sectionHeader}>
            ...
            <h2 className={styles.sectionTitle}>Exceptional Catering Services</h2>
          ...
          <div className={styles.cardsGrid}>
            <div className={styles.card}>
              <img
                src="/images/services/wedding.svg"
            ...
            <div className={styles.card}>
              <img
                src="/images/services/corporate.svg"
